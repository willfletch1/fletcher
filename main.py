...
if __name__ == '__main__':
  parser = argparse.ArgumentParser ( 
                    prog='Fletcher',
                    description='Fletcher will try to find a list of residues within a fixed distance from each other. \nConcept: Federico Sabbaddin & Jon Agirre.',
  ...
  parser.add_argument ( '-r', '--residues', help = "A list of residues, one-letter code and comma separated, e.g. G,F", default = "F", required = True )                       
  ...
  residue_list = args.residues.split(",")
